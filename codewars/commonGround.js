/*codewar challenge for the day link: https://www.codewars.com/kata/57212c55b6fa235edc0002a2/train/javascript
7 kyu: Dinner Plans
...
function commonGround(s1, s2){
    let result = s2.split(" ").filter(x => s1.split(" ").includes(x)).join(" ") || "death"
    return result;
  }