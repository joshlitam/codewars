/*codewar challenge for the day link: https://www.codewars.com/kata/5904d222e1bfd3354e000026/train/javascript
7 kyu: Remove Duplication
...
const removeDuplication = arr => arr.filter(x => arr.lastIndexOf(x) == arr.indexOf(x))