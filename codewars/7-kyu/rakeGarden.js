/*codewar challenge for the day link: https://www.codewars.com/kata/571c1e847beb0a8f8900153d/train/javascript
...
function rakeGarden(garden) {
  return garden.split(" ").map(x => x == "gravel" ? x = x : (x == "rock" ? x = "rock" : x = "gravel")).join(" ")
}