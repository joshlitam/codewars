/*codewar challenge for the day link: https://www.codewars.com/kata/53b2f6934a240823f4000abc/train/javascript
7 kyu: uniquePush - No Dupes!
...
function uniquePush(arr, obj) {
  if (!obj.phoneNumber) {
    ...
    if (arr.map(x => x.phoneNumber).includes(obj.phoneNumber)) {
